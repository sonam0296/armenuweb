                ...
                <Row>
                    <Col md={12} lg={12} xs={12} xl={12}>
                        <div className="card-header bg-white text-center">
                            <img className="rounded" src={this.props.state.resturantDetail.restaurant_image ? this.props.state.resturantDetail.restaurant_image.image_url : process.env.REACT_APP_DEFAULT_IMAGE} width="100px" height="100px" />
