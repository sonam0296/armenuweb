...
import imge from '../../../assets/img/theme/Food-2.jpg'
...
class CityResturant extends React.Component {
    ...
    redirectRestaurant(restaurantName, id,hostingAddress) {
        this.props.STORE_RESTAURANT(id);
        this.props.STORE_HOSTING_ADDRESS(hostingAddress);
                                                    ...
                                                    return (
                                                        <>
                                                            <Col lg="4" xl="3" sm="12" md="6" >
                                                                <a href={`https://${hotel.hosting_Address}`} style={{textDecoration:"none"}}>              
                                                                    <div className=" img-wrapper"
                                                                        ...
                                                                        //  onClick={() => this.redirectRestaurant(hotel.restaurant_Name, hotel._id, hotel.hosting_Address)}
                                                                    >
