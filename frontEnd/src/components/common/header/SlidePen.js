...
export class CartSlidePen extends Component {
    ...
    onCallDeleteItem = async (data,i,item_price) => {
        ...
        if(cart.myCart.length === 1){
            console.log("Clear Cart ============> ");
            this.onCallClearCart();
        }
        else{
                                    ...
                                    return(
                                        ...
                                        <Col sm={6} md={4} lg={4} xs={6}>
                                            <div className="justify-content-center">
                                                ...
                                                <img src={data.menu_item_id.item_image ? data.menu_item_id.item_image.image_url : process.env.REACT_APP_DEFAULT_IMAGE}
