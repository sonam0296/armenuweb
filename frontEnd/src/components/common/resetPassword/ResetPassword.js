...
class ResetPassword extends Component {
    ...
    onResetPassword = async () => {
        ...
        if(this.state.Password !== this.state.confirmPassword){
           errorToaster('Password and ConfirmPassword are not same..!');
        ...
        else
        {
            ...
            if (response && response.data) {
                const { history } = this.props;
                successToaster('Password Reset Successfull..!');
                setTimeout(() => {
                    history.push('/login')
                }, 1000);
            }
                                            ...
                                            <FormGroup>
                                                <InputGroup className="input-group-alternative">
                                                    ...
                                                    <Input placeholder={i18next.t("Confirm Password")} type="password"
                                                        autoComplete="new-password" onChange={this.handleconfirmPassword}
