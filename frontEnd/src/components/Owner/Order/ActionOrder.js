...
class ActionOrder extends React.Component {
  ...
  render() {
    if (userData.userType === "owner") {
      if (this.props.last_status === "Just Created") {
        return (
          <>
            <td>
              <Row>
      ...
      else if (this.props.last_status === "Accepted by Restaurant") {
        return (
          <>
            <td>
              <Col>
      ...
      else if (this.props.last_status === "Rejected by Restaurant") {
        return (
          <>
            <td>
        ...
        if (this.props.delivery_type === "Pickup" && this.props.delivery_status === "Picked Up") {
          return (
            <>
              <td>
                {i18next.t("No actions for you right now!")}
        ...
        else if (this.props.delivery_type === "Pickup") {
          return (
            <td>
              <Button
                size="sm"
      ...
      else if (this.props.last_status === "Served") {
        return (
          <>
            <td>
              {i18next.t("No actions for you right now!")}
      ...
      else if (this.props.last_status === "Canceled by Client") {
        return (
          <>
            <td>
              {i18next.t("No actions for you right now!")}
