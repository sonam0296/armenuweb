...
export class AddNewItem extends Component {
  ...
  onAddDish = async () => {
    const { item_description, item_name, item_price, item_image, veg } = this.state;
    const adddish = {
    ...
    if (response && response.data) {
      ...
      this.props.getMenu();
      this.props.notification("Item successfully added!");
      this.props.afterAdd();
      this.setState({
        item_description: "",
        item_name: "",
            ...
            <Card className="bg-secondary shadow border-0">
              <CardBody className="p-lg-5">
                <Form>
                  ...
                  <FormGroup className="text-center font-weight-bold mb-3">
