...
function appetizarReducer(state = initState, action) {
  switch (action.type) {
    ...
    case "STORE_HOSTING_ADDRESS":
      return {
        ...state,
        hostingAddress: action.res,
      }
    ...
    case "TEMP_TOKEN":
      return {
        ...state,
        tempToken: action.res,
      };
    case "STORE_AGGREGATOR_ID":
      return {
        ...state,
        StoreAggregatorId: action.res,
      };
    case "STORE_TABLE_NOTIFICATION":
      return {
        ...state,
        TableNotification: action.res,
      };
    case "STORE_GREETINGS_INFORMATION":
      return {
        ...state,
        Greetings: action.res,
      };
    ...
    case REHYDRATE:
      return {
        ...
        registrationToken:
          action.payload && action.payload.registrationToken ? action.payload.registrationToken : null,
        ...
        storeCurrentPlan:
          action.payload && action.payload.storeCurrentPlan
            ...
            : {},
        StoreAggregatorId:
          action.payload && action.payload.StoreAggregatorId
            ? action.payload.StoreAggregatorId
            : {},
        hostingAddress:
          action.payload && action.payload.hostingAddress
            ? action.payload.hostingAddress
            : "",
        TableNotification:
          action.payload && action.payload.TableNotification
            ? action.payload.TableNotification
            : [],
        Greetings:
          action.payload && action.payload.Greetings
...
export const reducer = appetizarReducer;
